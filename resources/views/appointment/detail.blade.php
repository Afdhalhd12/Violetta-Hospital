    ...
    @section('content')
        ...
        <div class="container my-4">
            ...
            <div class="dashboard-hero">
                <div>
                    <h1 class="display-5 fw-bold mb-3">Appointment History</h1>
        ...
        <script>
            function showModal(apt) {
                ...
                let content = `
                    ...
                    <li><strong>Doctor Name:</strong> <span>${apt.doctor.name}</span></li>
            ...
            <li><strong>Conclusion:</strong>
                <div class="notes-content">${apt.response ?? 'Tidak ada'}</div>
            </li>
            </ul>
        `;
